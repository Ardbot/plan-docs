...
2. Называем tiles_XYZ
3. Назначаем папку G:\tiles
4. Tiles directory layout - TMS layout (для формата `/{z}/{x}/{y}`)
5. Назначаем для слоёв наше хранилище.
6. Запускаем кеширование в хранилище.
